...
<%@page import="de.fh_dortmund.kosys.hear_my_song.util.Version"%><html>
<%
	/*
...
<title>hear-my-song <%=Version.VALUE%></title>
</head>
...
<body>
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
        	<div class="container">
				<a class="brand" href="${pageContext.request.contextPath}">hear-my-song</a>
			</div>
		</div>
	</div>
	<div class="container">
